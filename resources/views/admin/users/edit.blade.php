            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                <div class="flex p-2">
                    <a href="{{ route('admin.users.index') }}"
                        class="px-4 py-2 bg-green-700 hover:bg-green-500 text-slate-100 rounded-md">Usuários</a>
                </div>
                <div class="flex flex-col p-2 bg-slate-100">
                    <form method="POST" action="{{ route('admin.users.update', $user->id) }}">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <label for="name" class="block text-sm font-medium text-gray-700"> Senha </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            <button type="submit"
                                class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-md">Editar</button>
                        </div>
                    </form>
                </div>
                <div class="mt-6 p-2 bg-slate-100">
                    <h2 class="text-2xl font-semibold">Funções</h2>
                ...
                <div class="mt-6 p-2 bg-slate-100">
                    <h2 class="text-2xl font-semibold">Permissões</h2>
                    <div class="flex space-x-2 mt-4 p-2">
                        @if ($user->permissions)
                        ...
                        <form method="POST" action="{{ route('admin.users.permissions', $user->id) }}">
                            ...
                            <div class="sm:col-span-6">
                                <label for="permission"
                                    class="block text-sm font-medium text-gray-700">Permissão</label>
